...
!(function (t, e) {
    ...
    function j(t, e) {
        for (
            ...
            n &&
            (n === Ft.ghost || "none" === R(n, "display") || (e && !f(n, e)));
    ...
    var M = [],
        ...
        K = {
            mount: function (e) {
                for (var t in I)
                    !I.hasOwnProperty(t) || t in e || (e[t] = I[t]);
            ...
            pluginEvent: function (e, n, o) {
                ...
                M.forEach(function (t) {
                    n[t.pluginName] &&
                        (n[t.pluginName][i] &&
                            n[t.pluginName][i](N({ sortable: n }, o)),
                ...
                if (
                    ...
                    if (i)
                        return (
                            ...
                            O("revert"),
                            Ft.eventCanceled ||
                                (J ? Q.insertBefore(V, J) : Q.appendChild(V)),
                            M(!0)
                        );
            ...
            function M(t) {
                return (
                    ...
                    s.dragoverBubble ||
                        n.rootEl ||
                        l === document ||
                        (V.parentNode[W]._isOutsideThisEl(n.target),
                        t || Yt(n)),
                    !s.dragoverBubble &&
                        n.stopPropagation &&
                        n.stopPropagation(),
